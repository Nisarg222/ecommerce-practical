...
import { shop_feature ,products } from '../data/Data'
    ...
    return (
        <div>
            ...
            <div className='sm:mx-20 lg:flex 2xl:mx-40'>
                <div className='mx-6'>
                    <h1 className='text-2xl font-semibold' style={{color: '#45595b'}}>Fresh products shop</h1>
                    ...
                    <div>
                        ...
                        <div className='relative w-96 max-w-full md:w-full'>
                            <div className='relative'>
                                <img className='w-full relative' src='../img/banner-products.jpg' alt="" />
                            </div>
                            <div className='absolute top-2/4 -translate-y-1/2 -right-4 font-bold text-xl md:text-3xl lg:text-xl md:right-6 lg:-right-5 w-24'>
                                <h3 className='' style={{color: '#ffb524'}}>Fresh products Banner</h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        return (
                            <div key={val.id} className='box border rounded-lg border-orange-400 mx-auto mb-6 xl:mb-16 w-full'>
                                <div className='w-full relative overflow-clip'>
                                    ...
                                    <span className='absolute top-3 left-3 text-white text-lg py-1 px-4 rounded-xl' style={{backgroundColor: '#ffb524'}}>products</span>
                                </div>
                                ...
                                <div className='flex justify-between items-center mb-8 mx-6 lg:flex-col xl:flex-row xl:-mb-6 lg:mx-2 xl:mx-3 '>
                                    ...
                                    <div className='border rounded-full border-orange-400 py-2 px-4 lg:px-2 '>
                                        ...
                                        <button onClick={() => dispatch(addToCart(val))} className='font-semibold' style={{color: '#2a334f'}}>{val.cart}</button>
                                    </div>
                                </div>
                            </div>
                        )
