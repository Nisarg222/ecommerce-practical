    ...
    return (
        <div className='mt-40 container ml-auto mr-auto'>
            <div className='flex flex-col mb-10 mx-4 md:mx-20 lg:flex lg:justify-between lg:flex-row lg:mx-10 lg:gap-10'>
                <h1 className='text-3xl font-semibold mb-6 lg:text-4xl lg:flex lg:justify-center lg:items-center' style={{color: '#45595b'}}>Newly added products</h1>
            </div>
                    ...
                    return (
                        <div key={val.id} className='box border rounded-lg border-orange-400 mx-auto mb-6 w-full'>
                            <div className='w-full relative overflow-clip'>
                                ...
                                <span className='absolute top-3 right-3 text-white text-lg py-1 px-4 rounded-xl' style={{backgroundColor: '#2a334f'}}>Jeans</span>
                            </div>
