    ...
    return (
        <div className='mt-40 px-6 py-10 sm:px-20 md:px-24 lg:px-16 xl:px-20' style={{backgroundColor: '#45595b'}}>
            <div className='py-10 lg:grid lg:grid-cols-3 lg:items-center xl:flex xl:justify-between '>
                <div>
                    <h1 className='text-3xl font-semibold lg:text-4xl lg:grid-cols-1' style={{color: '#2a334f'}}>ShopSwoon</h1>
                    <p className='text-md' style={{color: '#fff'}}>New products</p>
                </div>
                ...
                <ul className='flex justify-end'>
                    <li className='mx-1'><i className='fab fa-twitter py-3 px-3 social rounded-full border '></i></li>
                    <li className='mx-1'><i className='fab fa-facebook-f  py-3 px-4 social rounded-full border '></i></li>
                    <li className='mx-1'><i className='fab fa-youtube py-3 px-3 social rounded-full border '></i></li>
                    <li className='mx-1'><i className='fab fa-linkedin-in py-3 px-3 social rounded-full border'></i></li>
                </ul>
            </div>
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-y-8 lg:grid-cols-4'>
                <div>
                    ...
                    <button className='read duration-500 relative py-2 mt-6 right-0 top-0 px-6 border rounded-full font-semibold text-md' type="submit">Read More</button>
                </div>
                <div>
            ...
            <div className='m-auto text-center'>
                <p className='font-medium' style={{color: '#ffffff80'}}><strong style={{color: '#2a334f'}}>&copy;Shopswoon Ecommerce, </strong>All Right Reserved by Rodi Shammout</p>
            </div>
        </div>
    )
}
