...
const Header = () => {
  ...
  const totalFavItems = useSelector((state) => state.cart.totalFavItems);
  ...
  return (
    <div>
      <div className="md:container md:mx-auto hidden lg:flex lg:justify-between text-white text-sm main p-4 top box-border">
        ...
        <div className="pr-4">
          <span className="hover:cursor-pointer hov transition">
            Privacy Policy
          </span>
      ...
      <div className="md:container md:mx-auto flex justify-between m-6 sticky z-10">
        <div className="main-text text-3xl sm:text-4xl font-extrabold md:ml-5">
          <Link to="/">ShopSwoon</Link>
        </div>
        <ul
        ...
        >
          ...
          >
            ...
            >
              <span className="absolute top-2 right-0 w-6 h-6 text-xs search flex justify-center items-center bord text-white">
                {totalItems}
              </span>
            </Link>
            <Link
              to="/favorite"
              className="fa fa-heart fa-2x main-text p-3 relative icon-hov"
            >
              <span className="absolute top-2 right-0 w-6 h-6 text-xs search flex justify-center items-center bord text-white">
                {totalFavItems}
              </span>
